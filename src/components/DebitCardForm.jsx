...
const DebitCardForm = ({ onClose, onSubmit, initialData }) => {
  ...
  return (
    <div className="debit-card-form-overlay">
      <div className="debit-card-form-container">
        <div className="debit-card-form-header">
          <h2>{initialData ? 'Edit Debit Card' : 'Add Debit Card'}</h2>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" className="submit-btn">
            {initialData ? 'Update Card' : 'Add Debit Card'}
          </button>
        </form>
      </div>
    </div>
